...
|图像分割|DeepLabv3+/MobileNetv3_large/bn|CityScapes|>= 99% of FP32 （[0.7328 mIoU on val, Output_stride=32，multi-scale_test=false](https://github.com/PaddlePaddle/PaddleSeg/blob/release/v0.8.0/docs/model_zoo.md)）|1000ms|[Paddle](https://paddle-inference-dist.bj.bcebos.com/AI-Rank/models/Paddle/deeplabv3p_mobilenetv3_large_cityscapes_inference.tar.gz) [Tensorflow](https://github.com/tensorflow/models/blob/master/research/deeplab/g3doc/model_zoo.md)|

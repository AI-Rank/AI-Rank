...
best_acc1 = 0
rank_logger = ai_rank_logger.logger()
...
def validate(val_loader, model, criterion, args):
    ...
    if args.gpu is not None:
        tmp = tmp.cuda(args.gpu, non_blocking=True)
    rank_logger.info('warmup_begin, warmup_samples:{}'.format(args.warmup * args.batch_size))
    ...
    rank_logger.info('avg_ips:{}images/sec'.format(cnt / batch_time.sum))

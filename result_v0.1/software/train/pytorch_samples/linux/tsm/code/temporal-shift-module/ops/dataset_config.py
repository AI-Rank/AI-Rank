...
ROOT_DATASET = r'/home/data/'  # '/data/jilin/'


def return_ucf101(modality):
    filename_categories = 'annotations/classInd.txt'
    if modality == 'RGB':
        root_data = ROOT_DATASET + 'rawframes'
        filename_imglist_train = 'ucf101_train_split_1_rawframes.txt'
        filename_imglist_val = 'ucf101_val_split_1_rawframes.txt'
        prefix = 'img_{:05d}.jpg'
    elif modality == 'Flow':
...
def return_kinetics(modality):
    ...
    if modality == 'RGB':
        ...
        filename_imglist_train = 'data/train.list'
        filename_imglist_val = 'data/val.list'
        prefix = 'img_{:05d}.jpg'
    else:
        raise NotImplementedError('no such modality:' + modality)
    return filename_categories, filename_imglist_train, filename_imglist_val, root_data, prefix
